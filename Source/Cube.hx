...
class Cube {
    ...
    public function new(color:ColorSpec, texture:RectangleTexture, context:Context3D) {
		...
		var vertexData = new Vector<Float> ([
			// X, Y, Z                        U, V   R, G, B, A
			 side / 2,  side / 2, -side / 2,  0, 1,  color.back.r, color.back.g, color.back.g, color.back.a,  // Back
			-side / 2,  side / 2, -side / 2,  1, 1,  color.back.r, color.back.g, color.back.g, color.back.a,
			-side / 2, -side / 2, -side / 2,  1, 0,  color.back.r, color.back.g, color.back.g, color.back.a,
			 side / 2, -side / 2, -side / 2,  0, 0,  color.back.r, color.back.g, color.back.g, color.back.a,

			-side / 2,  side / 2, -side / 2,  0, 1,  color.left.r, color.left.g, color.left.b, color.left.a,   // Left
			-side / 2,  side / 2,  side / 2,  1, 1,  color.left.r, color.left.g, color.left.b, color.left.a,
			-side / 2, -side / 2,  side / 2,  1, 0,  color.left.r, color.left.g, color.left.b, color.left.a,
			-side / 2, -side / 2, -side / 2,  0, 0,  color.left.r, color.left.g, color.left.b, color.left.a,

			-side / 2,  side / 2,  side / 2,  0, 1,  color.front.r, color.front.g, color.front.b, color.front.a,   // Front
			 side / 2,  side / 2,  side / 2,  1, 1,  color.front.r, color.front.g, color.front.b, color.front.a,
			 side / 2, -side / 2,  side / 2,  1, 0,  color.front.r, color.front.g, color.front.b, color.front.a,
			-side / 2, -side / 2,  side / 2,  0, 0,  color.front.r, color.front.g, color.front.b, color.front.a,

			 side / 2,  side / 2, -side / 2,  1, 1,  color.right.r, color.right.g, color.right.b, color.right.a,   // Right
			 side / 2,  side / 2,  side / 2,  0, 1,  color.right.r, color.right.g, color.right.b, color.right.a,
