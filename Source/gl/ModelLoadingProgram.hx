...
/**
 * The ModelLoadingProgram is used in the model loading and is called from the which then calls it with its
 * vertex and other properties.Up to this point the Scene has called programs directly after obtaining the
 * vertex information from the drawable objects.
 */
